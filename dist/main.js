...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_displayItems__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/displayItems */ \"./src/modules/displayItems.js\");\n\r\n\r\n\r\ndocument.addEventListener('DOMContentLoaded', _modules_displayItems__WEBPACK_IMPORTED_MODULE_1__[\"default\"])\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _tvMazeApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tvMazeApi */ \"./src/modules/tvMazeApi.js\");\n/* harmony import */ var _createItems__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createItems */ \"./src/modules/createItems.js\");\n/* harmony import */ var _commentsPopup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./commentsPopup */ \"./src/modules/commentsPopup.js\");\n/* harmony import */ var _likesApi__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./likesApi */ \"./src/modules/likesApi.js\");\n/* harmony import */ var _commentsApi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./commentsApi */ \"./src/modules/commentsApi.js\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst getItems = async () => {\r\n    const allItems = await (0,_tvMazeApi__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\r\n    return allItems;\r\n}\r\n\r\nconst getLikes = async () => {\r\n    const likes = await (0,_likesApi__WEBPACK_IMPORTED_MODULE_3__[\"default\"])()\r\n    return likes;\r\n}\r\n\r\n\r\nconst displayItems = async () => {\r\n    const items = await getItems();\r\n    const itemLikes = await getLikes();\r\n\r\n   items.forEach((item, index) => {\r\n   \r\n    (0,_createItems__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(item, itemLikes);\r\n\r\n    const commentsSection = document.querySelectorAll('.comment-btn');\r\n    const commentBtns = commentsSection[commentsSection.length - 1]\r\n    commentBtns.addEventListener('click', () => {\r\n        ;(0,_commentsPopup__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(item);\r\n\r\n      /*  const movieComments = async () => {\r\n            const movieComment = await getComments(item.show.id);\r\n            return movieComment;\r\n        }\r\n        \r\n        const totalComments = movieComments();\r\n        console.log(totalComments)*/\r\n        const windowSlide = document.querySelector('.comments-popup');\r\n        windowSlide.classList.add('comments-popup-toggle');\r\n\r\n        /*const commentDiv = document.querySelector('.comment-text');\r\n        const newComment = document.createElement('p');\r\n        newComment.textContent = totalComments;*/\r\n\r\n        const userNames = document.querySelectorAll('.name-input')\r\n        const userName = userNames[userNames.length - 1]\r\n\r\n        const commentTexts = document.querySelectorAll('.comment-input')\r\n        const commentText = commentTexts[commentTexts.length - 1]\r\n\r\n        const submitComments = document.querySelectorAll('.comment-button')\r\n        const submitComment = submitComments[submitComments.length - 1]\r\n\r\n        submitComment.addEventListener('click', async () => {\r\n            await (0,_commentsApi__WEBPACK_IMPORTED_MODULE_4__.addComments)(item.show.id, userName.value, commentText.value);\r\n        })\r\n    })\r\n   \r\n   })\r\n\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayItems);\n\n//# sourceURL=webpack://webpack-demo/./src/modules/displayItems.js?");
